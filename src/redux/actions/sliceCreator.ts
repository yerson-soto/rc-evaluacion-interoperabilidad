...
// export interface CrudSliceOptions<T, State extends CrudState<T>, Name extends string = string, Extend extends SliceCaseReducers<State> = {}> {
//   name: Name;
//   initialState: State;
//   idSource: keyof T;
//   extend?: Extend;
...
// export function createCrudSlice<T, State extends CrudState<T>, Name extends string = string, Extend extends SliceCaseReducers<State> = {}>({
//   name,
//   initialState,
//   idSource,
//   extend,
